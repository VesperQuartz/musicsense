    ...
    <KeyboardAvoidingView
      ...
      <View className="flex-1 bg-black p-2">
        ...
        <BottomSheet
          ...
          <BottomSheetView className="flex flex-1 gap-4 p-4">
            ...
            <BottomSheetView className="mb-4">
              ...
              />
              {errors.description && (
                <Text className="ml-1 mt-1 text-sm text-red-500">{errors.description.message}</Text>
              )}
            </BottomSheetView>
            <Button
        ...
        <BottomSheet
          ...
          <BottomSheetView className="flex flex-1 gap-4 p-4">
            <Text className="mb-2 text-xl font-bold text-white">Add Suggested Track to Memory</Text>
            <View className="mb-4">
              <Controller
                control={addTrackFormControl}
                rules={{
                ...
                render={({ field: { onChange, value } }) => (
                  <View>
                    ...
                    {categories.isSuccess && (!categories.data || categories.data.length === 0) && (
